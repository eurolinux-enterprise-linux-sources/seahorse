...
/* VOID:STRING,DOUBLE (../libseahorse/seahorse-marshal.list:1) */
void
...
/* VOID:OBJECT,UINT (../libseahorse/seahorse-marshal.list:2) */
void
seahorse_marshal_VOID__OBJECT_UINT (GClosure     *closure,
                                    GValue       *return_value G_GNUC_UNUSED,
                                    guint         n_param_values,
                                    const GValue *param_values,
                                    gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:OBJECT,POINTER (../libseahorse/seahorse-marshal.list:3) */
void
seahorse_marshal_VOID__OBJECT_POINTER (GClosure     *closure,
                                       GValue       *return_value G_GNUC_UNUSED,
                                       guint         n_param_values,
                                       const GValue *param_values,
                                       gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:OBJECT,UINT,POINTER (../libseahorse/seahorse-marshal.list:4) */
void
seahorse_marshal_VOID__OBJECT_UINT_POINTER (GClosure     *closure,
                                            GValue       *return_value G_GNUC_UNUSED,
                                            guint         n_param_values,
                                            const GValue *param_values,
                                            gpointer      invocation_hint G_GNUC_UNUSED,
                                            gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__OBJECT_UINT_POINTER) (gpointer     data1,
                                                          ...
                                                          gpointer     arg_3,
                                                          gpointer     data2);
  GMarshalFunc_VOID__OBJECT_UINT_POINTER callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
...
/* VOID:OBJECT,OBJECT (../libseahorse/seahorse-marshal.list:5) */
void
seahorse_marshal_VOID__OBJECT_OBJECT (GClosure     *closure,
                                      GValue       *return_value G_GNUC_UNUSED,
                                      guint         n_param_values,
                                      const GValue *param_values,
                                      gpointer      invocation_hint G_GNUC_UNUSED,
